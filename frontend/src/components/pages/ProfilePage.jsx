...
export default function ProfilePage() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-white/70 mb-4">Please login to view your profile</p>
          <Link 
            to="/login" 
            className="px-6 py-3 bg-white text-black hover:bg-white/90 rounded-xl transition-colors inline-block"
          >
            Go to Login
          </Link>
        </div>
              ...
              <div className="bg-black border-2 border-white/20 p-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex items-center px-4 py-3 bg-white/10 border border-white/10 rounded-xl">
                  ...
                  <div>
                    <label className="block text-sm text-white/70 mb-2">Member Since</label>
                    <div className="flex items-center px-4 py-3 bg-white/10 border border-white/10 rounded-xl">
              ...
              <div className="bg-black border-2 border-white/20 p-8">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-white/70">Sections Mastered</div>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-black border-2 border-white/20 p-6">
                ...
                <div className="space-y-3">
                  {user.authProvider === 'email' && (
                    <button 
                      className="w-full px-4 py-3 bg-white/10 hover:bg-white/10 border border-white/10 rounded-xl transition-colors text-left text-sm"
                  ...
                  <Link
                    to="/subjects"
                    className="block w-full px-4 py-3 bg-white/10 hover:bg-white/10 border border-white/10 rounded-xl transition-colors text-left text-sm"
                  >
                    Continue Learning
                  </Link>
              ...
              <div className="bg-black border-2 border-white/20 p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between py-2">
                    <span className="text-sm text-white/70">Account Status</span>
