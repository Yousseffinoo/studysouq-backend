...
import { Check, ArrowRight, Brain, BookOpen, FileText, ClipboardCheck } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto z-10">
          ...
          >
            <p className="text-white text-[18px] sm:text-[22px] md:text-[26px] font-normal leading-[1.3]">
              Trained on 10,000+ handmade questions.
            </p>
            <p className="text-white text-[18px] sm:text-[22px] md:text-[26px] font-normal leading-[1.3]">
              Built for Edexcel IGCSE.
            </p>
            <p className="text-white text-[18px] sm:text-[22px] md:text-[26px] font-normal leading-[1.3]">
              Your personal AI maths tutor.
            </p>
          </motion.div>
      ...
      <section className="relative py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <FeatureCard
              icon={FileText}
              title="100% Edexcel Questions"
              description="Every question follows Edexcel exam style. Practice with real exam-level difficulty."
              delay={0.4}
            />
            <FeatureCard
              icon={ClipboardCheck}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <Link
                to="/subjects"
                className="w-full inline-flex items-center justify-center gap-2 px-10 py-5 bg-white text-black text-[18px] sm:text-[20px] font-bold hover:bg-white/90 transition-all duration-200"
              >
                Try it free
                <ArrowRight className="w-5 h-5" />
              </Link>
